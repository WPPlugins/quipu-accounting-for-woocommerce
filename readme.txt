...
Quipu plugin for WooCommerce 2 allows you to automate all your business' billing. Send custom invoices and manage your
online store!
...
All you can do with Quipu Accounting for WooCommerce 2:
...
This plugin requires that you have an account created in both [WooCommerce 2](https://www.woothemes.com/woocommerce/) and [Quipu](https://getquipu.com/en).

== Installation ==

Follow the steps listed below to install the Quipu plugin for WooComerce 2
